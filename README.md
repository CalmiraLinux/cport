...
- [X] Поиск портов среди всех присутствующих в системе и всех установленных;
...
- `install` - установка порта;
    - `--port`, `-p` - сборка и установка порта;
    - `-y` - отвечать `yes` на каждые вопросы;
- `remove` - удаление порта;
    - `--port`, `-p` - удаление файлов порта;
    - `-y` - отвечать `yes` на каждые вопросы;
